...
while(($row = mysqli_fetch_array($result))) {
    ...
    foreach ($arr as $key => $value) {
        if($typOtazky == "checkbox3" || $typOtazky == "checkbox5" || $typOtazky == "checkbox7"){
            if($i == 0){
                $i++;
                ?>
            ...
            <br>
            <?php
        }else if($typOtazky == "radius button3" || $typOtazky == "radius button5" || $typOtazky == "radius button7"){
            if($i == 0){
                $i++;
                ?>
    ...
    $(document).ready(function(){
        $("#submitFormular").click(function(){
            ...
            for(let j = 0; j < array.length; j ++){
                if(array[j].classList.contains('checkbox3') || array[j].classList.contains('checkbox5') || array[j].classList.contains('checkbox7')){
                    ...
                    var result = {Otazka,Odpoved};
                    questions.push(result);
                }else if(array[j].classList.contains('optionlist')){
                    var e = document.getElementById("ddlViewBy");
                    var odpoved = e.options[e.selectedIndex].value;
